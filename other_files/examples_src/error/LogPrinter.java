...
import org.cendra.commons.util.service.ServiceError;
import org.cendra.commons.util.service.ServiceException;
...
public class LogPrinter {
	...
	public void print(String name, int level, ResponseEntity responseEntity) {
		try {
	...
	public void print(String name, int level, ServiceException serviceException) {
		try {
			ObjectMapper mapper = new ObjectMapper();
			String msg = "\n\n"
					+ mapper.writerWithDefaultPrettyPrinter()
							.writeValueAsString(serviceException);
	...
	public void print(String name, int level, ServiceError serviceError) {
		try {
			ObjectMapper mapper = new ObjectMapper();
			String msg = "\n\n"
					+ mapper.writerWithDefaultPrettyPrinter()
	...
	public void print(String name, int level, Exception exception) {
		try {
			...
			String msg = "\n\n"
					+ mapper.writerWithDefaultPrettyPrinter()
							.writeValueAsString(new ServiceException(exception));
